...
<%//se for chamado por iframe deixa apenas a parte de cadastro da página
			if (iframe != null) {%>
<link rel="stylesheet" type="text/css" href="./css/cargos.css" />
<%}%>
</head>
<body>
	<div id="wrapper">
		...
		<%if (iframe == null) {%>
			...
			<div class="box grid_16 tabs">
				<ul class="tab_header clearfix">
					<li><a href="#tabs-1"><fmt:message key="cargos.cadastro" />
					</a></li>
					<li><a href="#tabs-2" class="round_top"><fmt:message key="cargos.pesquisa" />
					</a></li>
				</ul>
				...
				<div class="toggle_container">
					<div id="tabs-1" class="block">
						<div class="section">
							<form name='form'
								action='${ctx}/pages/cargos/cargos'>
								...
								<div class="columns clearfix">
									<div class="col_66">
										<fieldset>
											<label class="campoObrigatorio"><fmt:message key="cargos.nome" /></label>
											<div>
