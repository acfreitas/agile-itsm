...
<head>
    ...
    <script>
        ...
        function limpar(){
    	  window.location = '${ctx}/solicitacaoCargo/solicitacaoCargo.load';
        }
	...
	function adicionarLinhaSelecionada(objeto, id, desc, obrigatorio, detalhe){
		...
		var coluna = linha.insertCell(0);
		coluna.className = "celulaEsquerda";
		coluna.innerHTML = '<img id="imgDel' + contLinha + '" style="cursor: pointer;" title="<fmt:message key="citcorpore.comum.cliquaParaExcluir"/>" src="<%=Constantes.getValue("SERVER_ADDRESS") + Constantes.getValue("CONTEXTO_APLICACAO")%>/imagens/delete.png" onclick="removerLinhaTabela(\''+nomeTabela+'\', this.parentNode.parentNode.rowIndex);">';
		coluna = linha.insertCell(1);
		coluna.className = "celulaEsquerda";
		coluna.innerHTML = desc + '<input type="hidden" id="id' + objeto + contLinha + '" name="id'+objeto+'" value="' + id + '" />';
		coluna = linha.insertCell(2);
		coluna.className = "celulaEsquerda";
		coluna.innerHTML = detalhe.substring(0,11) +'<span style="cursor: pointer;" title = "header=[<fmt:message key="analiseRequisicaoPessoal.detalheCompleto"/>] body=['+ detalhe +']"> ... </span>';
	...
	function removerLinhaTabela(idTabela, rowIndex) {
 	...
 	function serializaObjetos(objeto, tipo){
		...
		for (var i = 1; i < arrayId.length; i++){
 			...
 			//Validação se o campo não é nulo
 			if(chk){
    ...
    <div class="box grid_16 tabs" style='margin: 0px 0px 0px 0px;'>
        <div class="toggle_container">
            <div id="tabs-2" class="block" style="overflow: hidden;">
                        <form name='form' action='${ctx}/pages/solicitacaoCargo/solicitacaoCargo'>
								...
								<div class="col_100">
									<div class="col_50">
									<fieldset>
										<label class="campoObrigatorio"><fmt:message key="solicitacaoCargo.formacaoAcademica"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("formacaoAcademica")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarFormacaoAcademica"/>'></label>
											<div  id="gridFormacaoAcademica">
												<table class="table" id="tblFormacaoAcademica" class="table" style="display: none;">
													<tr>
														...
														<th style="width: 10%;font-size:10px;"><fmt:message key="solicitacaoCaro.obrig"/></th>
													</tr>
												</table>
											</div>
									</fieldset>
									...
									<div class="col_50">
									<fieldset>
										<label ><fmt:message key="solicitacaoCargo.certificacoes"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("certificacao")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarCertificacao"/>'></label>
								...
								<div class="col_100">
								  <div class='col_50'>
								  <fieldset >
									<label><fmt:message key="solicitacaoCargo.treinamentos"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("curso")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarCurso"/>'></label>
										<div  id="gridCurso">
								  ...
								  <div class='col_50'>
									  <fieldset >
											<label><fmt:message key="solicitacaoCargo.experienciaInformatica"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("experienciaInformatica")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarExperienciaEmInformatica"/>' ></label>
								...
								<div class="col_100">
								  <div class='col_50'>
								  <fieldset >
									<label><fmt:message key="solicitacaoCargo.idiomas"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("idioma")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarIdioma"/>' ></label>
										<div  id="gridIdioma">
								  ...
								  <div class='col_50'>
									  <fieldset >
											<label><fmt:message key="solicitacaoCargo.experienciaAnterior"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("experienciaAnterior")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarExperienciaAnterior"/>' ></label>
								...
								<div class="col_100">
								  <div class='col_50'>
									  <fieldset >
											<label class="campoObrigatorio"><fmt:message key="solicitacaoCargo.conhecimentos"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("conhecimento")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarConhecimento"/>' ></label>
								  ...
								  <div class='col_50'>
								  <fieldset >
									<label class="campoObrigatorio"><fmt:message key="solicitacaoCargo.habilidades"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("habilidade")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarHabilidade"/>'></label>
								...
								<div class="col_100">
									<div class='col_50'>
									  <fieldset >
											<label class="campoObrigatorio"><fmt:message key="solicitacaoCargo.atitudes"/><img src="${ctx}/template_new/images/icons/small/grey/magnifying_glass.png"  onclick='exibirSelecao("atitudeIndividual")' style="cursor: pointer;" title='<fmt:message key="solicitacaoCargo.adicionarAtitudeIndividual"/>' ></label>
		...
		<div id='divSelecao' style='height:180px;overflow: auto;'>
			<table class="table" id="tblSelecao" class="table">
				<tr>
					...
					<th style="width: 40%;">s</th><fmt:message key="rh.detalhes"/>
				</tr>
			</table>
		</div>
