	...
	function addLinhaParametrosGerais(id, atributo, valor, check, required){
		...
		if(required=='true')
			require = 'required';
		if(check=='N')
			coluna.innerHTML = '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoGeral' + countGeral + '" '+require+' name="idAtributoGeral" value="' + id + '" />' + atributo;
		else
			coluna.innerHTML = atributo + '<input type="hidden" readonly="readonly" class="outputext" id="idAtributoGeral' + countGeral + '" '+require+' name="idAtributoGeral" value="' + id + '" />';
		
		coluna = row.insertCell(1);
		if(check=='N') {
			coluna.innerHTML = '<input type="text" maxlength="200" id="valorAtributoGeral' + countGeral + '" '+require+' size="40" name="valorAtributoGeral" value="' + valor + '"/>';
		} else {
			if(valor=='S')
				checked = "checked";
			coluna.innerHTML = '<input type="checkbox" id="valorAtributoGeral' + countGeral + '"  ' + checked + ' '+require+' name="valorAtributoGeral" value="' + valor + '"/>';
		}
	}
