													...
													<div class="control-group">
														...
														<div class="controls">
															<select name="driverConexao">
																<!--<option value="MYSQL"><fmt:message key="start.instalacao.mysql" /></option>-->
																<option value="PostgreSQL"><fmt:message key="start.instalacao.postgresql" /></option>
																<option value="Oracle"><fmt:message key="start.instalacao.oracle" /></option>
																<option value="Microsoft SQL Server"><fmt:message key="start.instalacao.sqlserver" /></option>
															</select>
														</div>
													</div>
												</div>
