...
create index fk_monitoramento_tipoitemconf_idx on monitoramentoativos(idtipoitemconfiguracao);
...
create index fk_notificacao_monitoramento_idx on notificacaousuariomonit(idmonitoramentoativos);
create index fk_notificacao_usuario_idx on notificacaousuariomonit(idusuario);
...
create index fk_notificacaogrupo_monit_idx_idx on notificacaogrupomonit(idmonitoramentoativos);
create index fk_notificacao_usuario_idx_idx on notificacaogrupomonit(idgrupo);
...
create index fk_caracteristica_monit_idx on caracteristicamonit(idcaracteristica);
create index fk_monitoramento_carac_idx on caracteristicamonit(idmonitoramentoativos);
...
create index fk_scriptmonit_monit_idx on scriptmonit(idmonitoramentoativos);
