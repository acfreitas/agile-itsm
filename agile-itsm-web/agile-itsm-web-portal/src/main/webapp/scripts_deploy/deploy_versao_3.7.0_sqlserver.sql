...
ALTER TABLE integranteviagem ADD  idtarefa int NULL;

-- FIM - thiago.borges - 30/06/2014

-- INICIO - renato.jesus - 27/06/2014
ALTER TABLE rh_funcaoexperienciaprofissionalcurriculo ALTER COLUMN descricaofuncao VARCHAR(600);
...
ALTER TABLE rh_candidato ALTER COLUMN cpf VARCHAR(14) NULL;
...
ALTER TABLE rh_competencia ADD COLUMN nivelcompetencia INT NULL;
...
ALTER TABLE rh_enderecocurriculo ALTER COLUMN logradouro VARCHAR(100);
