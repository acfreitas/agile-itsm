...
ALTER TABLE COLETAPRECO MODIFY (PRAZOMEDIOPAGTO INT(11) NOT NULL);
...
alter table itemconfiguracao add informacoesadicionais varchar2(4000) default '' not null;
...
alter table ocorrenciasolicitacao alter notificarresponsavel default 'N';
