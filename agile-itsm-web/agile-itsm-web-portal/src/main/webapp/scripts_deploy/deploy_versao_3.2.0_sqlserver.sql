...
ALTER TABLE historicoic ALTER COLUMN historicoversao DECIMAL(5,2);

-- FIM - FLAVIO JUNIOR NEVES SANTANA SILVA - 22/01/2014

-- INICIO - MARIO HAYASAKI JUNIOR - 29/01/2014

UPDATE ufs SET siglauf = 'GO' WHERE iduf = 4;

-- FIM - MARIO HAYASAKI JUNIOR - 29/01/2014
...
-- INICIO - MARIO HAYASAKI JUNIOR - 04/02/2014

EXEC sp_rename 'auditoriaitemconfig.datahoraalteracao', 'datahoraalteracaoold', 'COLUMN';
alter table dbo.auditoriaitemconfig ADD datahoraalteracao DATETIME NOT NULL;

-- FIM - MARIO HAYASAKI JUNIOR - 04/02/2014
...
ALTER TABLE linhabaseprojeto ALTER COLUMN usuarioultalteracao VARCHAR(255) NOT NULL;
ALTER TABLE linhabaseprojeto ALTER COLUMN usuariosolmudanca VARCHAR(255) NULL;
...
ALTER TABLE fornecedor add idtiporegistro int;
ALTER TABLE fornecedor add idfrequencia int;
ALTER TABLE fornecedor add idformacontato int;
...
ALTER TABLE empregados ALTER COLUMN nome varchar(256) NOT NULL;
ALTER TABLE empregados ALTER COLUMN nomeprocura varchar(256) NULL;

-- FIM - EDU RODRIGUES BRAZ - 17/03/2014

-- INICIO - EDU RODRIGUES BRAZ - 24/02/2014

ALTER TABLE contatosolicitacaoservico ALTER COLUMN nomecontato varchar(255) NOT NULL;

-- FIM - EDU RODRIGUES BRAZ - 24/02/2014

-- INICIO - RODRIGO PECCI ACORSE - 25/02/2014

alter table modelosemails alter column titulo varchar(255);
...
CREATE TABLE importardados ( 
  idimportardados      INT NOT NULL IDENTITY (1, 1), 
...
CREATE TABLE controleimportardados ( 
  idcontroleimportardados INT NOT NULL IDENTITY (1, 1), 
  idimportardados         INT NOT NULL, 
...
ALTER TABLE importconfig ADD idimportardados INT;

ALTER TABLE importconfig ADD datafim DATE;

ALTER TABLE importconfigcampos ADD idimportardados INT;
