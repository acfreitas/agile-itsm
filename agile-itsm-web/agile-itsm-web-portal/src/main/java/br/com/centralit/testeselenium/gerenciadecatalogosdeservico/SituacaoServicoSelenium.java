...
public class SituacaoServicoSelenium extends TesteCitsmart implements MetodosGenericos
{

	private final String page = "/pages/situacaoServico/situacaoServico.load";
	...
	public String cadastrarRegistro() throws Exception{
		...
		nomeCadastrado = UtilWebSelenium.geraStringAleatoriaDoCampo(driver, "nomeSituacaoServico");

		driver.findElement(By.id(getNomeDoBotaoDeLimpar())).click();
		
		UtilWebSelenium.aguardar(2000);
		
		driver.findElement(By.id("nomeSituacaoServico")).sendKeys(nomeCadastrado);
	...
	@Test
	public void cit_464_CadastrarSituacaoServico() throws Exception
	{
	...
	@Test
	public void cit_184_NomeCampoObrigatorio() throws Exception
	{
	    ...
	    assertEquals("Nome da Situação do Serviço: Campo obrigatório", UtilWebSelenium.closeAlertAndGetItsText(driver));
	    
	}
	
	
	@Test
	public void cit_647_EditarSituacaoServico() throws Exception
	{
		...
		assertEquals(nomeCadastrado, driver.findElement(By.id("nomeSituacaoServico")).getAttribute("value"));
		
	}
	
	@Test
	public void cit_652_ExcluirSituacaoServico() throws Exception
	{
	...
	{
		return  "pesqLockupLOOKUP_SITUACAOSERVICO_nomesituacaoservico";
	}
	...
	{
		return "Pesquisa de Situação de Serviço";
	}
	...
	public String getNomeDoBotaoDeLimparPesquisa()
	{
		...
		return "btnLimparLOOKUP_SITUACAOSERVICO";
	}
