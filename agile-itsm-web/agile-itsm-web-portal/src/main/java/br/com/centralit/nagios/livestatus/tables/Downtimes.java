...
from a Livestatus TCP-socket/file status.dat.
	...
	public Map<String, String> asArrayString(String table, String filter) throws NumberFormatException {
		...
		addToHashtable("duration", getAsString(Duration()));
		addToHashtable("end_time", getAsString(End_time()));
		addToHashtable("entry_time", getAsString(Entry_time()));
		addToHashtable("fixed", getAsString(Fixed()));
		...
		addToHashtable("start_time", getAsString(Start_time()));
		addToHashtable("triggered_by", getAsString(Triggered_by()));
