		...
		if (idServicoContrato != null){
        		...
        		if (colUnidades != null){
        			...
        			if (prioridade != null && !prioridade.trim().equalsIgnoreCase("")){
        			    ...
        			    if(idServicoContrato!= null && unidadeDTO.getIdUnidade()!= null){
	        			    PrioridadeServicoUnidadeDTO prioridadeServicoUnidadeAux = prioridadeServicoUnidadeService.restore(idServicoContrato, unidadeDTO.getIdUnidade());
